...
func request_CalcService_Calculate_0(ctx context.Context, marshaler runtime.Marshaler, client CalcServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_CalcService_Calculate_0(ctx context.Context, marshaler runtime.Marshaler, server CalcServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CalculateRequest
	var metadata runtime.ServerMetadata
...
func RegisterCalcServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CalcServiceServer) error {
	...
	mux.Handle("POST", pattern_CalcService_Calculate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_CalcService_Calculate_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_CalcService_Calculate_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterCalcServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CalcServiceClient) error {
	...
	mux.Handle("POST", pattern_CalcService_Calculate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_CalcService_Calculate_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_CalcService_Calculate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "calculate"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_CalcService_Calculate_0 = runtime.ForwardResponseMessage
)
